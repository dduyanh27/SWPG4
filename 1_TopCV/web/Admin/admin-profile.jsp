            ...
            <div class="main">
                ...
                <div class="profile-content">
                            ...
                            <div class="avatar" onclick="document.getElementById('avatarFile').click()">
                                <c:choose>
                                    <c:when test="${not empty sessionScope.admin.avatarURL}">
                                        <!-- Nếu có avatarURL trong DB thì lấy -->
                                        <img src="assets/img/admin/${sessionScope.admin.avatarURL}" 
                                             alt="Avatar" id="avatarImage">
                                    </c:when>
                                    <c:otherwise>
                                        <!-- Nếu avatarURL null thì dùng ảnh mặc định -->
                                        <img src="assets/img/admin/admin.png" 
                                             alt="Default Avatar" id="avatarImage">
                                    </c:otherwise>
                                </c:choose>
                            </div>
                    ...
                    <div>
                        ...
                        <form class="form-section" method="post" action="updateadminprofile">
                            ...
                            <div class="form-grid">
                                    ...
                                    <div>
                                        <label>
                                            <input type="radio" name="gender" value="Nam" 
                                                   ${sessionScope.admin.gender eq 'Nam' ? 'checked' : ''}> Nam
                                        </label>
                                        <label>
                                            <input type="radio" name="gender" value="Nữ" 
                                                   ${sessionScope.admin.gender eq 'Nữ' ? 'checked' : ''}> Nữ
                                        </label>
                                        <label>
                                            <input type="radio" name="gender" value="Khác" 
                                                   ${sessionScope.admin.gender eq 'Khác' ? 'checked' : ''}> Khác
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <textarea id="address" name="address" class="form-textarea" 
                                              placeholder="Nhập địa chỉ đầy đủ...">${sessionScope.admin.address}</textarea>
                                </div>

                                <div class="form-group full-width">
                                    <label class="form-label" for="bio">Giới thiệu bản thân</label>
                                    <textarea id="bio" name="bio" class="form-textarea" 
                                              placeholder="Mô tả ngắn về bản thân..." maxlength="500">${sessionScope.admin.bio}</textarea>
                                </div>
                            </div>
                        ...
                        <!-- Security Section -->
                        <form class="form-section security-section" method="post" action="adminchangepassword">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-input" 
                                           value="${admin.updatedAt}" readonly 
