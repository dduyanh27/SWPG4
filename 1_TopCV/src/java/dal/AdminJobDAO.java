        ...
        try (PreparedStatement ps = c.prepareStatement(sql); ResultSet rs = ps.executeQuery()) {
            ...
            while (rs.next()) {
                Job job = new Job(
                        ...
                        (rs.getTimestamp("PostingDate") == null ? null : rs.getTimestamp("PostingDate").toLocalDateTime()),
                        (rs.getTimestamp("ExpirationDate") == null ? null : rs.getTimestamp("ExpirationDate").toLocalDateTime()),
